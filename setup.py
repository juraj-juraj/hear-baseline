...
setup(
    ...
    url="https://github.com/hearbenchmark/hear-baseline",
    license="Apache-2.0",
    long_description=long_description,
    long_description_content_type="text/markdown",
    project_urls={
        "Bug Tracker": "https://github.com/hearbenchmark/hear-baseline/issues",
        "Source Code": "https://github.com/hearbenchmark/hear-baseline",
    },
